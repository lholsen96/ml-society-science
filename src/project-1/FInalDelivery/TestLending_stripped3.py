...
for iter in range(n_tests):
    ...
    X_test_opposite_foreign["woman_A92"] = [1 if v == 0 else 0 for v in X_test_opposite_foreign["woman_A92"]]    
...
#print(X_test)
X_test.to_csv("data_manwom.csv")
X_test_opposite_foreign.to_csv("data_manwom_switched.csv")

data = pandas.read_csv("data_manwom.csv")
data_switch = pandas.read_csv("data_manwom_switched.csv")


data_manwoman = pandas.read_csv("data_manwom.csv")
...
data["Different"] = data.A != data_switch.A 
print(data[data.Different == True].head())
