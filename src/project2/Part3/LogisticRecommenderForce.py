...
class LogisticRecommenderForce:
    ...
    def __init__(self, n_actions, n_outcomes, allow_update = 1, force_alt_med = 0, force_action = 2):
        ...
        self.force_alt_med = force_alt_med
    ...
    def recommend(self, user_data):
        if (self.force_alt_med > 0):
            self.force_alt_med -= 1
            return self.force_action
        ...
        drug2_prob_outcomes = self.predict_proba(user_data, 2)
        print("1 og 2")
        print(drug_prob_outcomes)
        print(drug2_prob_outcomes)
        ...
        drug_estimate_reward2 = drug2_prob_outcomes[0,0]*self.reward(2, 0) + drug2_prob_outcomes[0,1]*self.reward(2, 1)
        
        print(drug_estimate_reward, drug_estimate_reward2)
        return np.argmax([placebo_estimate_reward, drug_estimate_reward, drug_estimate_reward2])
